...
if __name__ == '__main__':
    ...
    vad_processor = VADProcessor(
        default_vad_model_name="../Model/speech_fsmn_vad_zh-cn-16k-common-pytorch",
        device="cpu",
        ncpu=4,
    ...
    dummy_vad_audio_path = "E:\Code\PythonDir\MCP\mcp-server-funasr\Data\_20240821153822.mp3"
    samplerate = 16000
